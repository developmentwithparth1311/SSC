...
copy /Y dist\SSC-Setup-1.0.9.exe C:\Users\smash\Desktop\SSC\SSC-Setup-1.0.9.exe
echo.
echo DONE: frontend\desktop\dist\SSC-Setup-1.0.9.exe
echo       C:\Users\smash\Desktop\SSC\SSC-Setup-1.0.9.exe
endlocal