...
FOOTPRINT_LOCATIONS: Dict[str, FootprintLocation] = {
    ...
    "local_storage_session_wrap": FootprintLocation(
        location_id="local_storage_session_wrap",
        store="localStorage",
        keys_or_content="ssc_session_wrap_enc",
        tier=FootprintTier.SECRET,
        panic_action="remove",
        logout_action="remove",
        engine3_step=None,
        notes="AES-GCM device wrap of JWT (TASK B); never plaintext ssc_token.",
    ),
    "local_storage_device_wrap": FootprintLocation(
        location_id="local_storage_device_wrap",
        store="localStorage",
        keys_or_content="ssc_device_wrap_secret",
        tier=FootprintTier.SECRET,
        panic_action="keep",
        logout_action="keep",
        engine3_step=None,
        notes="Per-device AES key; useless without ciphertext blobs (cleared on panic/logout).",
    ),
